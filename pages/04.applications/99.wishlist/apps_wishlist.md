...
| [SimpleX Chat Server](https://github.com/simplex-chat/simplex-chat/blob/stable/docs/SERVER.md) | Provacy-oriented messenger without any user ID | [Upstream](https://github.com/simplex-chat/simplexmq) |
